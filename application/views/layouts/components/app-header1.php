				...
				<div class="app-header header sticky">
					<div class="container-fluid main-container">
						<div class="d-flex">
							...
							<!-- sidebar-toggle-->
							<a class="logo-horizontal" href="<?php echo base_url('index'); ?>">
										...
										<div class="d-flex order-lg-2">
											...
											<div class="dropdown d-flex country">
												...
												<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
													...
													<a class="dropdown-item d-flex align-items-center" href="javascript:void(0);"> <img src="<?php echo base_url('assets/images/flag-images/3.png'); ?>" alt="img" class="me-2 country language-img"> <span class="fs-13 text-wrap text-dark fw-semibold"> Germany</span> </a>
													<a class="dropdown-item d-flex align-items-center" href="javascript:void(0);"> <img src="<?php echo base_url('assets/images/flag-images/5.png'); ?>" alt="img" class="me-2 country language-img"> <span class="fs-13 text-wrap text-dark fw-semibold"> Russia</span> </a>
													<a class="dropdown-item d-flex align-items-center" href="javascript:void(0);"> <img src="<?php echo base_url('assets/images/flag-images/6.png'); ?>" alt="img" class="me-2 country language-img"> <span class="fs-13 text-wrap text-dark fw-semibold"> United Kingdom</span> </a>
													<a class="dropdown-item d-flex align-items-center" href="javascript:void(0);"> <img src="<?php echo base_url('assets/images/flag-images/2.png'); ?>" alt="img" class=" me-2 country language-img"> <span class="fs-13 text-wrap text-dark fw-semibold"> Canada</span> </a>
												</div>
											</div>
											<!-- COUNTRY -->
												...
												<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
													...
													<div class="header-dropdown-list message-menu">
														<div class="dropdown-item d-flex">
															<a href="<?php echo base_url('cart'); ?>" class="p-0">
																...
																src="<?php echo base_url('assets/images/products/7.jpg'); ?>">
															</a>
															<div class="wd-50p d-flex flex-column">
																<a href="<?php echo base_url('cart'); ?>" class="p-0 h6 text-dark fw-semibold mb-0">Flower pot home decores</a>
																<span>Qty: 1</span>
														...
														<div class="dropdown-item d-flex">
															<a href="<?php echo base_url('cart'); ?>" class="p-0">
																<img
																class="avatar avatar-lg br-7 me-3 align-self-center cover-image" alt="product-image"
																src="<?php echo base_url('assets/images/products/4.jpg'); ?>">
															</a>
															<div class="wd-50p d-flex flex-column">
																<a href="<?php echo base_url('cart'); ?>" class="p-0 h6 text-dark fw-semibold mb-0">Smart watch</a>
																<span>Qty: 3</span>
														...
														<div class="dropdown-item d-flex">
															<a href="<?php echo base_url('cart'); ?>" class="p-0">
																<img
																class="avatar avatar-lg br-7 me-3 align-self-center cover-image" alt="product-image"
																src="<?php echo base_url('assets/images/products/5.jpg'); ?>">
															</a>
															<div class="wd-50p d-flex flex-column">
																<a href="<?php echo base_url('cart'); ?>" class="p-0 h6 text-dark fw-semibold mb-0">Headphones</a>
																<span>Qty: 2</span>
																<span>Status: <span class="text-success">In
																	Stock</span></span>
															</div>
														...
														<div class="dropdown-item d-flex">
															<a href="<?php echo base_url('cart'); ?>" class="p-0">
																<img
																class="avatar avatar-lg br-7 me-3 align-self-center cover-image" alt="product-image"
																src="<?php echo base_url('assets/images/products/30.jpg'); ?>">
															</a>
															<div class="wd-50p d-flex flex-column">
																<a href="<?php echo base_url('cart'); ?>" class="p-0 h6 text-dark fw-semibold mb-0">Furniture (chair)</a>
																<span>Qty: 1</span>
																<span>Status: <span class="text-success">In
																	Stock</span></span>
															</div>
														...
														<div class="dropdown-item d-flex border-bottom-0">
															<a href="<?php echo base_url('cart'); ?>" class="p-0">
																<img
																class="avatar avatar-lg br-7 me-3 align-self-center cover-image" alt="product-image"
																src="<?php echo base_url('assets/images/products/8.jpg'); ?>">
															</a>
															<div class="wd-50p d-flex flex-column">
																<a href="<?php echo base_url('cart'); ?>" class="p-0 h6 text-dark fw-semibold mb-0">Running Shoes</a>
																<span>Qty: 4</span>
													...
													<div class="dropdown-footer d-felx justify-content-between align-items-center">
														<a class="btn btn-primary btn-pill btn-sm"
															href="<?php echo base_url('checkout'); ?>"><i class="fe fe-check-circle"></i>
															CHECKOUT</a>
											...
											<div class="dropdown d-flex notifications nav-link-notify">
												...
												<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow ">
													...
													<div class="notifications-menu header-dropdown-scroll">
														<a class="dropdown-item border-bottom d-flex" href="<?php echo base_url('notify-list'); ?>">
															<div>
														...
														<a class="dropdown-item d-flex" href="<?php echo base_url('notify-list'); ?>">
															<div>
													...
													<div class="text-center dropdown-footer">
														<a class="btn btn-primary btn-sm btn-block text-center" href="<?php echo base_url('notify-list'); ?>">VIEW ALL NOTIFICATIONS</a>
													</div>
												</div>
											</div>
											<!-- NOTIFICATIONS -->
											<div class="dropdown d-flex message">
												...
												<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
													...
													<div class="message-menu message-menu-scroll">
														<a class="dropdown-item border-bottom d-flex align-items-center" href="<?php echo base_url('chat'); ?>">
															<img class="avatar avatar-md brround cover-image"
																src="<?php echo base_url('assets/images/users/male/28.jpg'); ?>" alt="person-image">
														...
														<a class="dropdown-item border-bottom d-flex align-items-center" href="<?php echo base_url('chat'); ?>">
															<img
																...
																src="<?php echo base_url('assets/images/users/male/32.jpg'); ?>" alt="person-image">
															<div class="wd-90p">
																<div class="d-flex">
														...
														<a class="dropdown-item border-bottom d-flex align-items-center" href="<?php echo base_url('chat'); ?>">
															<img class="avatar avatar-md brround me-3 cover-image"
																src="<?php echo base_url('assets/images/users/female/21.jpg'); ?>" alt="person-image">
															<div class="wd-90p">
																<div class="d-flex">
														...
														<a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('chat'); ?>">
															<img class="avatar avatar-md brround me-3 cover-image"
																src="<?php echo base_url('assets/images/users/male/33.jpg'); ?>" alt="person-image">
															<div class="wd-90p">
																<div class="d-flex">
														...
														<a class="dropdown-item border-bottom d-flex align-items-center border-bottom-0" href="<?php echo base_url('chat'); ?>">
															<img class="avatar avatar-md brround cover-image"
																src="<?php echo base_url('assets/images/users/male/8.jpg'); ?>" alt="person-image">
															<div class="wd-90p ms-2">
																<div class="d-flex">
																	<h5 class="mb-0 text-dark fw-semibold ">Madeleine</h5>
																	<small class="text-muted ms-auto">
													...
													<div class="text-center dropdown-footer">
														<a class="btn btn-primary btn-sm btn-block text-center" href="<?php echo base_url('chat'); ?>">MARK ALL AS READ</a>
													</div>
												</div>
											</div>
											<!-- MESSAGE-BOX -->
											...
											<div class="dropdown d-flex profile-1">
												<a href="javascript:void(0)" data-bs-toggle="dropdown"
													...
													<img src="<?php echo base_url('assets/images/users/male/15.jpg'); ?>" alt="profile-user"
												...
												<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow"
													...
													<a class="dropdown-item text-dark fw-semibold border-top" href="<?php echo base_url('profile'); ?>">
														<i class="dropdown-icon fe fe-user"></i> Profile
													</a>
													<a class="dropdown-item text-dark fw-semibold" href="<?php echo base_url('email-inbox'); ?>">
														<i class="dropdown-icon fe fe-mail"></i> Inbox
														<span class="badge bg-success float-end">3</span>
													</a>
													<a class="dropdown-item text-dark fw-semibold" href="<?php echo base_url('settings'); ?>">
														<i class="dropdown-icon fe fe-settings"></i> Settings
													</a>
													<a class="dropdown-item text-dark fw-semibold" href="<?php echo base_url('faq'); ?>">
														<i class="dropdown-icon fe fe-alert-triangle"></i>
														Support ?
													</a>
													<a class="dropdown-item text-dark fw-semibold" href="<?php echo base_url('login'); ?>">
