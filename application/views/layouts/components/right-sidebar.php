                                    ...
                                    <div>
                                        ...
                                        <ul class="mb-0 list-group list-group-flush">
                                            <li class="list-group-item d-flex border-0">
                                                <div class="d-flex">
                                                    <span class="avatar brround avatar-md cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/male/32.jpg'); ?>">
                                                        <span class="avatar-status bg-green"></span>
                                                    </span>
                                                    <a href="<?php echo base_url('chat'); ?>" class="ms-2 p-0">
                                            ...
                                            <li class="list-group-item d-flex border-0">
                                                <div class="d-flex">
                                                    <span class="avatar brround avatar-md cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/female/1.jpg'); ?>">
                                                    </span>
                                                    <a href="<?php echo base_url('chat'); ?>" class="ms-2 p-0">
                                            ...
                                            <li class="list-group-item d-flex border-0">
                                                <div class="d-flex">
                                                    <span class="avatar brround avatar-md cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/female/21.jpg'); ?>">
                                                        <span class="avatar-status bg-green"></span>
                                                    </span>
                                                    <a href="<?php echo base_url('chat'); ?>" class="ms-2 p-0">
                                                        <h6 class="mt-1 mb-0 fw-semibold">Maryam Naz</h6>
                                            ...
                                            <li class="list-group-item d-flex border-0">
                                                <div class="d-flex">
                                                    <span class="avatar brround avatar-md cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/female/23.jpg'); ?>">
                                                    </span>
                                                    <a href="<?php echo base_url('chat'); ?>" class="ms-2 p-0">
                                            ...
                                            <li class="list-group-item d-flex border-0">
                                                <div class="d-flex">
                                                    <span class="avatar brround avatar-md cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/male/33.jpg'); ?>">
                                                        <span class="avatar-status bg-green"></span>
                                                    </span>
                                                    <a href="<?php echo base_url('chat'); ?>" class="ms-2 p-0">
                                            ...
                                            <li class="list-group-item d-flex border-0">
                                                <div class="d-flex">
                                                    <span class="avatar brround avatar-md cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/male/15.jpg'); ?>">
                                                    </span>
                                                    <a href="<?php echo base_url('chat'); ?>" class="ms-2 p-0">
                                            ...
                                            <li class="list-group-item d-flex border-0">
                                                <div class="d-flex">
                                                    <span class="avatar brround avatar-md cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/female/15.jpg'); ?>">
                                                        <span class="avatar-status bg-green"></span>
                                                    </span>
                                                    <a href="<?php echo base_url('chat'); ?>" class="ms-2 p-0">
                                                        <h6 class="mt-1 mb-0 fw-semibold">Khadija Mehr</h6>
                                        ...
                                        <ul class="mb-0 list-group list-group-flush">
                                            <li class="list-group-item d-flex border-0">
                                                <div class="d-flex">
                                                    <span class="avatar brround avatar-md cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/male/10.jpg'); ?>">
                                                    </span>
                                                    <a href="<?php echo base_url('chat'); ?>" class="ms-2 p-0">
                                            ...
                                            <li class="list-group-item d-flex border-0">
                                                <div class="d-flex">
                                                    <span class="avatar brround avatar-md cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/female/9.jpg'); ?>">
                                                    </span>
                                                    <a href="<?php echo base_url('chat'); ?>" class="ms-2 p-0">
                                            ...
                                            <li class="list-group-item d-flex border-0">
                                                <div class="d-flex">
                                                    <span class="avatar brround avatar-md cover-image" data-bs-image-src="<?php echo base_url('assets/images/users/female/11.jpg'); ?>">
                                                    </span>
                                                    <a href="<?php echo base_url('chat'); ?>" class="ms-2 p-0">
                                                        <h6 class="mt-1 mb-0 fw-semibold">Yolduz Rafi</h6>
